...
export default function Register() {
  ...
  const inputStyle = {
    ...
    backgroundColor: 'transparent', color: 'var(--text-main)', fontSize: '0.95rem'
  };
    ...
    <div style={{ backgroundColor: 'var(--bg-color)', minHeight: '100vh' }}>
      ...
      <div style={{
        ...
        <div style={{ marginTop: '1rem' }}>
          ...
          <h1 style={{ margin: 0, fontSize: '1.5rem', color: '#fff', fontWeight: 700 }}>创建账号</h1>
          <p style={{ margin: '0.5rem 0 0', fontSize: '0.85rem', color: 'rgba(255,255,255,0.6)' }}>注册墨阅，开启阅读之旅</p>
        </div>
      </div>
      ...
      <div style={{ padding: '2rem 1.5rem' }}>
          ...
          <div style={{ marginBottom: '1.25rem' }}>
            <div style={inputWrapStyle}>
              ...
              <input type="text" value={username} onChange={e => setUsername(e.target.value)}
                placeholder="请输入用户名" required style={inputStyle} />
            </div>
          </div>
          ...
          <div style={{ marginBottom: '1.25rem' }}>
            <div style={inputWrapStyle}>
              ...
              <input type="password" value={password} onChange={e => setPassword(e.target.value)}
                placeholder="请输入密码" required style={inputStyle} />
            </div>
          </div>
          ...
          <div style={{ marginBottom: '2rem' }}>
            <div style={inputWrapStyle}>
              ...
              <input type="password" value={confirmPassword} onChange={e => setConfirmPassword(e.target.value)}
                placeholder="请再次输入密码" required style={inputStyle} />
            </div>
          </div>
        ...
        <div style={{ textAlign: 'center', marginTop: '2rem' }}>
          <p style={{ fontSize: '0.9rem', color: 'var(--text-secondary)' }}>
            已有账号？
            <Link to="/login" style={{ color: '#ff7875', fontWeight: 600, marginLeft: '4px' }}>去登录</Link>
          </p>
        </div>
      </div>
    </div>
